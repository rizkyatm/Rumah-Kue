...
<body>
<?php 
    $sql = "SELECT * FROM promo WHERE id_kue= '$id_kue'";
        ...
        <!-- card -->
            <div class="row g-0" style="display: flex; width: 100%; gap: 10px;">
                ...
                <div class="card-body" > 
                   ...
                   <a href="landing.php"> <button style="position: absolute;width: 107px;height: 40px;left: 1150px;top: 489px;background: #D9D9D9;border-radius: 20px;background: #D9D9D9;border-radius: 20px;color: black;border: none;font-family: 'Poppins';font-style: normal;font-weight: 400;font-size: 20px;line-height: 30px;" class="btn btn-primary" type="button">Back</button></a>
